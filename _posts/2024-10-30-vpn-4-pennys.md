...
description: Create a cheap on-demand VPN with Tailscale and Hetzner Cloud. Ansible automation spins up exit nodes in 30 seconds for about $0.50/month.
date: 2024-10-30 17:00
categories: [ansible, network, vpn]
tags: [ansible, network, vpn, cloud, tailscale, wireguard]
---


![On-demand VPN exit node architecture with Tailscale and Hetzner](/assets/img/vpn-4-pennys.png "VPN for Pennies")
